...
@Component({
          ...
          <form class="auth-form" (ngSubmit)="onSignup()">
            ...
            <div class="form-group">
              ...
              <div class="input-wrapper">
                ...
                <button type="button" class="password-toggle" (click)="togglePassword()">{{ showPassword() ? '🙈' : '👁' }}</button>
              </div>
          ...
          <form class="auth-form" (ngSubmit)="submitPasswordReset()">
            ...
            <div class="form-group">
              ...
              <div class="input-wrapper">
                ...
                <button type="button" class="password-toggle" (click)="showResetPassword.update(value => !value)">{{ showResetPassword() ? '🙈' : '👁' }}</button>
              </div>
            </div>
  ...
  styles: [`
    ...
    .input-icon { position: absolute; left: 13px; z-index: 1; color: #64748b; font-size: .95rem; }
    .form-control {
      width: 100%;
      min-height: 48px;
